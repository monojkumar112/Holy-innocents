                ...
                <div className="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="ministryModalLabel">Involved Ministries</h1>
                        ...
                        <div className="modal-body">
                            <form onSubmit={handleSubmit} className="row">
                                ...
                                <div className="mb-md-3 col-md-6">
                                    <label htmlFor="social_links" className="form-label">Social Links <span className='text-success'>(Optional)</span></label>
                                    <input type="url" className="form-control" id="social_links" name="social_links" placeholder='Give your social profile link' />
                                </div>
                                <div className="mb-md-3 col-md-6">
                                    <label htmlFor="address" className="form-label">Address <span className="text-danger">*</span></label>
                                    <textarea className="form-control" id="address" name="address" rows="3" required placeholder="Enter your address"></textarea>
                                </div>
                                <div className="mb-md-3 col-md-6">
                                    <label htmlFor="message" className="form-label">Message</label>
                                    <textarea className="form-control" id="message" name="message" rows="3" placeholder="Write your message"></textarea>
                                </div>
                                ...
                                {status === 'success' && <div className="mt-2 text-success">Message sent.</div>}
                                {status === 'error' && (
