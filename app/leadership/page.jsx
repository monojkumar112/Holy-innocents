              ...
              <ul>
                ...
                >
                  ...
                  <ul className="section-content-ul">
                    ...
                    <li className="section-content-li">The Parish Secretary</li>
                    <li className="section-content-li">The Sisters of Mercy</li>
                    <li className="section-content-li">
                ...
                >
                  ...
                  <p>
                    ​Father Victor takes the Church‘s mission of evangelisation
                    very much to heart and has pioneered the introduction of the
                    Parish Evangelisation Cell System (PECS). He oversees PECS
                    in England and is a member of the PECS International
                ...
                >
                  <div className="liturgy-item-list pb-4 align-liader">
                    ...
                    <div className="liturgy-item-contents">
                      <h4 className="liader-title-2">Deacon Barry Chalkley</h4>
                      <p>
                        Barry has been a Permanent Deacon at Holy Innocents
                        since his ordination in 2004. Born in West London and
                        brought up in the Church of England he became a Catholic
                        in 1982, five years after his marriage to Liz. They have
                ...
                >
                  <div className="liturgy-item-list pb-4 align-liader">
                    ...
                    <div className="liturgy-item-contents">
                      <h4 className="liader-title-2">Deacon Wayne du Preez</h4>
                      <p>
                        Wayne was ordained to the Permanent Diaconate in July
                        2014 but had been active in the parish in youth work and
                        outreach prior to this. He was born and grew up in South
                        Africa, moving to the UK in 2000 and has been in the
                        parish since 2005.
                      </p>
                      <p>
                  ...
                  <div className="liturgy-item-list pb-4 align-liader">
                    ...
                    <div className="liturgy-item-contents">
                      ...
                      <p>
                        ...
                        social life of the parish, coordinating many social and
                        fundraising events as well as being a support to the
                        extraordinary ministers and working in our parish
                        school.
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="liturgy-item-list pb-4 align-liader">
                    <div className="liturgy-img-item">
                      <Image
                        src={"/assets/images/leader-ship/natahsa-wheeler.jpg"}
                        width={131}
                        height={146}
                        alt="leader-ship-1"
                      />
                    ...
                    <div className="liturgy-item-contents">
                      ...
                      <p>
                        Natasha runs the Parish Office, normally working Monday,
                        Wednesday and Friday from 10.30 am to 3.30 pm. She is
                        the administration manager and has charge of the parish
                        diary. Natasha is the first point of contact for parish
                        enquiries.
                      </p>
                      <p>
                        She is helped in the Parish Office by parishioners Janet
                        Welch and Claire Westley.{" "}
                      </p>
                    </div>
                  </div>
                </li>
                ...
                >
                  ...
                  <p>
                    ...
                    with the groups and activities involved in different aspects
                    of our parish life. The new PCRG team consists of Fr Victor,
                    Natasha Wheeler, parish secretary. (also parishioner), plus
                    4 parishioners; Aidan Twomey, Mike Delaney, Jackie Low and
                    Andrea Tutt.
                  </p>
                  <p>
